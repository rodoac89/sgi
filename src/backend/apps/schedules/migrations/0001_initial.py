# Generated by Django 3.2 on 2021-12-25 23:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day_petition', models.CharField(choices=[('1', 'Lunes'), ('2', 'Martes'), ('3', 'Miercoles'), ('4', 'Jueves'), ('5', 'Viernes'), ('6', 'Sabado'), ('0', 'Domingo')], default='1', max_length=1)),
                ('time_start_petition', models.TimeField(null=True)),
                ('time_finish_petition', models.TimeField(null=True)),
                ('recurrence', models.CharField(choices=[('07', 'Semanal'), ('01', 'Diario'), ('28', 'Mensual')], default='07', max_length=2)),
                ...
                ('datetime_petition', models.DateTimeField(blank=True, default=datetime.datetime(2021, 12, 25, 20, 47, 17, 211310))),
